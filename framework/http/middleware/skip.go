...
import (
	"general-agent/extension/stream"
	"general-agent/extension/xpath"
...
func SkipWithPathPrefix(prefixes ...string) SkipperFunc {
	return func(c *gin.Context) bool {
		...
		//	return false
		//}
		return stream.OfSlice(prefixes).AnyMatch(func(s string) bool {
			return xpath.UriMatch(s, path)
		})
	}
}
...
func NoSkipWithPathPrefix(prefixes ...string) SkipperFunc {
	return func(c *gin.Context) bool {
		...
		//}
		//return true
		return stream.OfSlice(prefixes).NoneMatch(func(s string) bool {
			return xpath.UriMatch(s, path)
		})
	}
}
